...
def main():
    ...
    if (args.scheduler == "SpeedScan") and args.no_gyms and args.no_pokestops:
        raise Exception("Please remove -nk (no pokestops) or -ng (no gyms) to enable -speed scanning.")
    if args.encounter:
